...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  */ /*!50003 TRIGGER `foodcategory_BEFORE_INSERT` BEFORE INSERT ON `foodcategory` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  */ /*!50003 TRIGGER `fooditems_BEFORE_INSERT` BEFORE INSERT ON `fooditems` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  */ /*!50003 TRIGGER `images_BEFORE_INSERT` BEFORE INSERT ON `images` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  */ /*!50003 TRIGGER `mealmealtype_BEFORE_INSERT` BEFORE INSERT ON `mealmealtype` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  */ /*!50003 TRIGGER `meals_BEFORE_INSERT` BEFORE INSERT ON `meals` FOR EACH ROW BEGIN
SET NEW.mealID = UUID(); 
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  */ /*!50003 TRIGGER `mealtype_BEFORE_INSERT` BEFORE INSERT ON `mealtype` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  */ /*!50003 TRIGGER `recipe_BEFORE_INSERT` BEFORE INSERT ON `recipe` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  */ /*!50003 TRIGGER `recipes_images_BEFORE_INSERT` BEFORE INSERT ON `recipes_images` FOR EACH ROW BEGIN
...
-- Dump completed on 2024-06-18  0:27:00
