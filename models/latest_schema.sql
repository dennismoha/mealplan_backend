...
CREATE TABLE `fooditems` (
  ...
  `foodsubcategory_id` varchar(36) NOT NULL,
  ...
  KEY `foodsubcategory_idx` (`foodsubcategory_id`),
  ...
  CONSTRAINT `foodsubcat` FOREIGN KEY (`foodsubcategory_id`) REFERENCES `foodsubcategory` (`foodsubcategory_id`)
...
CREATE TABLE `foodsubcategory` (
  `idFoodSubcategory` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idFoodSubcategory`),
  UNIQUE KEY `subcategory_name_UNIQUE` (`subcategory_name`),
  KEY `food_category_id_idx` (`food_category_id`),
  KEY `food_subcategory_idx` (`foodsubcategory_id`),
  CONSTRAINT `fksubcat_category` FOREIGN KEY (`food_category_id`) REFERENCES `foodcategory` (`food_categoryID`)
...
INSERT INTO `foodsubcategory` VALUES (11,'juicy fruits','juciy fruits are the best for digestion','65345f4a-58f6-11ef-9365-f816542ce27d','c3794f7f-3e0c-11ef-ba87-f816542ce27d','2024-08-13 01:01:15','2024-08-13 01:01:15'),(13,'Appetizers','Starters and small dishes','55dfe408-5959-11ef-987f-f816542ce27d','c3794f7f-3e0c-11ef-ba87-f816542ce27d','2024-08-13 12:49:29','2024-08-13 12:49:29'),(14,'meal-Appetizers','Starters and small dishes','e5ad3143-5959-11ef-987f-f816542ce27d','c3794f7f-3e0c-11ef-ba87-f816542ce27d','2024-08-13 12:53:31','2024-08-13 12:53:31');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `foodsubcategory_BEFORE_INSERT` BEFORE INSERT ON `foodsubcategory` FOR EACH ROW BEGIN
	set NEW.foodsubcategory_id = uuid();
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
CREATE TABLE `images` (
  ...
  CONSTRAINT `fk_images_foodsubcat` FOREIGN KEY (`entity_id`) REFERENCES `foodcategory` (`category_name`)
...
INSERT INTO `images` VALUES (1,'http://example.com/images/apple.jpg','91bf702c-58b0-11ef-9365-f816542ce27d','2024-08-12 13:41:25','2024-08-12 13:41:25','',NULL),(2,'http://example.com/images/carrot.jpg','91bf75bb-58b0-11ef-9365-f816542ce27d','2024-08-12 13:41:25','2024-08-12 13:41:25','',NULL);
...
-- Dump completed on 2026-09-03 13:58:05
